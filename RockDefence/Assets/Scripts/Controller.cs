...
public class Controller : MonoBehaviour {
	...
	void Start () {
		...
		if (SceneNumber == 1) {
			...
			Seven.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 6, 0.4f, 0.5f));
			Seven.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 8, 0.4f, 0.4f));
			Seven.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 1, 0.4f, 0));
			...
			Seven.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 4, 0.4f, 0.4f));
			Seven.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 5, 0f, 0.2f));
			Seven.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 8, 0f, 0));
			...
			Eight.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 1, 1, 1));
			Eight.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 10, 0.4f, 0.3f));
			...
			Nine.levelNumber = 9;
			Nine.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 5, 0, 0.4f));
			...
			Nine.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 1, 0, 1));
			Nine.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 1, 0, 0));
			Nine.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 3, 0f, 0.4f));
			...
			Ten.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 2, 0, 0));
			Ten.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 3, 0.4f, 0.2f));
			Ten.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 2, 0, 0.4f));
			Ten.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 2, 0.5f, 1));
			Ten.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 3, 0.4f, 0.2f));
		...
		// Second Scene
			...
			Five.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 6, 0, 1.6f));
			Five.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 20, 0, 0.8f));
			...
			Six.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 7, 0, 0.5f));
			Six.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 7, 0, 1.6f));
			Six.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 5, 2, 0.8f));
			Six.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 3, 0, 0.9f));
			Six.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 10, 0, 1.6f));
			Six.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 5, 0, 0.8f));
			Six.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 4, 0, 0.5f));
			LevelSequence.Add (Six);
			...
			Eight.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 1, 0.4f, 0.3f));
			Eight.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 2, 1, 1));
			Eight.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 5, 0.4f, 0.9f));
			Eight.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 3, 1, 1));
			Eight.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 1, 0.4f, 0.2f));
			Eight.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 7, 1, 1));
			...
			Nine.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 10, 0.4f, 0));
			...
			Nine.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 5, 1, 1));
			Nine.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 1, 0.4f, 0));
			Nine.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 20, 0.5f, 0));
			Nine.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 1, 1, 1));
			Nine.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 1, 0.4f, 0));
			Nine.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 1, 0.5f, 0));
			Nine.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 5, 1, 1));
			...
			Nine.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 1, 0.4f, 0));
			Nine.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 1, 0.5f, 0));
			Nine.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 30, 0.4f, 0.3f));
			...
			Ten.groupSequence = new List<GroupOfGroupies> ();
			Ten.levelNumber = 10;
			Ten.groupSequence.Add (new GroupOfGroupies ("CaveTroll", 3, 1, 1.6f));
			Ten.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 10, 0.4f, 0.2f));
			Ten.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 15, 0, 0.1f));
			Ten.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 10, 0, 1.6f));
			Ten.groupSequence.Add (new GroupOfGroupies ("GummyBear", 3, 1, 1.6f));
			Ten.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 15, 0, 1.6f));
			Ten.groupSequence.Add (new GroupOfGroupies ("TankBoss", 1, 0, 0));
			Ten.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 3, 1, 1));
			Ten.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 3, 0.4f, 0.2f));
			Ten.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 8, 0.5f, 0.4f));
			Ten.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 10, 1, 1));
			Ten.groupSequence.Add (new GroupOfGroupies ("TankBoss", 3, 1, 1.6f));
			Ten.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 3, 0.4f, 0.2f));
			...
			Ten.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 3, 1, 1));
			Ten.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 3, 0.4f, 0.2f));
			Ten.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 15, 0.5f, 0.4f));
			Ten.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 3, 1, 1));
			Ten.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 20, 0.4f, 0.2f));
			Ten.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 18, 0.5f, 0.4f));
