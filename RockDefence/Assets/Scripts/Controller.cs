...
public class Controller : MonoBehaviour {
	...
	void Start () {
		...
		soloCountText.text = "Guitar solos: " + soloCount.ToString ();
		...
		if (SceneNumber == 1) {
			...
			Five.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 4, 0.2f, 1.3f));
			...
			Seven.levelNumber = 7;
			Seven.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 8, 0, 0.8f));
			...
			Eight.groupSequence.Add (new GroupOfGroupies ("GummyBear", 1, 0.5f, 0));
			Eight.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 1, 0.5f, 0));
			...
			Ten.groupSequence.Add (new GroupOfGroupies ("CaveTroll", 1, 0.5f, 0));
			Ten.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 5, 0.5f, 0.1f));
		...
		// Second Scene
			...
			Nine.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 10, 0.5f, 0.1f));
			Nine.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 15, 0, 0.05f));
			Nine.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 5, 1, 1));
			Nine.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 15, 0, 0.05f));
			Nine.groupSequence.Add (new GroupOfGroupies ("GummyBear", 1, 1, 1.6f));
			Nine.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 15, 0, 0.1f));
			Nine.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 7, 1, 0.4f));
			Nine.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 15, 0, 0.1f));
			...
			Ten.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 25, 0, 0.2f));
			Ten.groupSequence.Add (new GroupOfGroupies ("CaveTroll", 3, 0, 0.5f));
			Ten.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 25, 0, 0.2f));
			Ten.groupSequence.Add (new GroupOfGroupies ("CaveTroll", 3, 0, 0.5f));
			Ten.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 35, 0.4f, 0.2f));
			Ten.groupSequence.Add (new GroupOfGroupies ("TankBoss", 6, 0, 0.3f));
			Ten.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 35, 0.4f, 0.2f));
		...
		// Final Scene
			...
			Ten.groupSequence.Add (new GroupOfGroupies ("TankBoss", 2, 0, 0));
			Ten.groupSequence.Add (new GroupOfGroupies ("CaveTroll", 2, 0, 1));
			Ten.groupSequence.Add (new GroupOfGroupies ("GummyBear", 3, 1, 1));
			Ten.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 2, 1, 1));
			Ten.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 6, 0.4f, 0.2f));
			Ten.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 2, 0.5f, 0.4f));
			Ten.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 2, 1, 1));
			Ten.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 5, 0.4f, 0.2f));
			Ten.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 2, 0.5f, 0.4f));
			Ten.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 2, 1, 1));
			Ten.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 5, 0.4f, 0.2f));
			Ten.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 2, 0.5f, 0.4f));
			Ten.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 2, 1, 1));
			Ten.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 5, 0.2f, 0.2f));
			Ten.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 2, 0.5f, 0.4f));
			Ten.groupSequence.Add (new GroupOfGroupies ("OldGroupie", 2, 1, 1));
			...
			Ten.groupSequence.Add (new GroupOfGroupies ("YoungGroupie", 3, 0.4f, 0.2f));
			Ten.groupSequence.Add (new GroupOfGroupies ("MediumGroupie", 2, 0.5f, 0.4f));
			Ten.groupSequence.Add (new GroupOfGroupies ("TankBoss", 6, 1, 2));
